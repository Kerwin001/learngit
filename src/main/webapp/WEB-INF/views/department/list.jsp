...
<s:debug/>
<s:actionerror/>
<s:form id="searchForm" namespace="/" action="department.action" method="post">
    <div id="container">
        <div class="ui_content">
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        <s:url namespace="/" action="department_input" var="inputurl"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:a namespace="/" action="department_input">
                                    ...
                                    编辑</s:a>
                                <s:url namespace="/" action="department_delete" id="deleteurl"><s:param name="dept.id"
                                                                                                      value="id"/></s:url>
