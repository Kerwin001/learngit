    ...
    <script>
        $(function () {
            ...
            $("#chart").change(function(){
                var  v = $(this).val();
                var condition = $("#searchForm").serialize();
                var url;
                if(v=="line"){
                    url = "saleChart_saleChartByLine.action?"+condition;
                }else if(v=="pie"){
                    url = "saleChart_saleChartByPie.action?"+condition
                }
                $.dialog.open(url,{
                    title:"销售报表",
                    width:800,
...
<s:form id="searchForm" action="saleChart" namespace="/" method="post">
<div id="container">
        ...
        <div class="ui_text_indent">
            <div id="box_border">
                ...
                <div id="box_center">
                    ...
                    图表
                    <s:select list="#{'line':'折线图','pie':'饼图'}" class="ui_select01" id="chart"/>
                </div>
                <div id="box_bottom">
