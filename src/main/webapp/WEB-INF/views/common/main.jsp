    ...
    <script>
        $(function(){
            ...
            $("#show_hide_btn").click(function(){
                if(flag){
                    $("#left_menu_cnt").hide(500);
                    $("#top_nav").css("width","90%");
                    $("#top_nav").css("left",90);
                    $("#main").css("left",60);
                    $("#show_hide_btn img").prop("src","images/common/nav_show.png");
                    flag=!flag;
                }else{
                    $("#left_menu_cnt").show(500);
                    $("#top_nav").css("width","77%");
                    $("#top_nav").css("left",304);
                    $("#main").css("left",280);
                    $("#show_hide_btn img").prop("src","images/common/nav_hide.png");
                    flag=!flag;
                }
            });
        });
...
<div id="top_nav">
    当前位置：<span id="here_area">系统&nbsp;>&nbsp;系统介绍</span>
</div>
<div id="main">
