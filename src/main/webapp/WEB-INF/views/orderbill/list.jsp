            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        <s:textfield name="qo.beginDate" value="%{#beginDate}" class="ui_input_txt02 Wdate"/>
                        ~
                        <s:date name="qo.endDate" format="yyyy-MM-dd" var="endDate"/>
                        <s:textfield name="qo.endDate" value="%{#endDate}" class="ui_input_txt02 Wdate"/>
                        供应商
            ...
            <div class="ui_tb">
                <table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    ...
                    <s:iterator value="#page.listData">
                        <tr>
                            <td><input type="checkbox" class="acb" data-oid="<s:property value="id"/>"/>
                            </td>
